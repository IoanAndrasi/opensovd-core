    ...
    for element in json_array {
            ...
            && search_name.is_none_or(|name| element.name == name)
        {
            ...
            return Some(EntityCollectionEntityIdDataDataIdGet200Response {
                ...
                data: sovd_api::types::Object::new(
                    to_value(any_value).expect("Failed to create read value"),
                ),
                r_errors: None,
                schema: None,
            });
    ...
    for element in json_array {
        if element.is_writable == writable {
            ...
            let read_value = EntityCollectionEntityIdDataDataIdGet200Response {
                id: element.identifier.to_string(),
                data: sovd_api::types::Object::new(
                    to_value(any_value).expect("Failed to filter writables"),
                ),
                r_errors: None,
                schema: None,
            };
...
pub fn find_by_identifier(
        ...
        .find(|e| e.identifier == search_identifier)
    {
        ...
        let read_value = EntityCollectionEntityIdDataDataIdGet200Response {
            id: element.identifier.to_string(),
            data: sovd_api::types::Object::new(
                to_value(any_value).expect("Failed to find by identifier"),
            ),
            r_errors: None,
            schema: None,
        };
...
pub fn find_by_name(
    ...
    if let Some(element) = json_array.into_iter().find(|e| e.name == search_name) {
        ...
        let read_value = EntityCollectionEntityIdDataDataIdGet200Response {
            id: element.identifier.to_string(),
            data: sovd_api::types::Object::new(
                to_value(any_value).expect("Failed to find by name"),
            ),
            r_errors: None,
            schema: None,
        };
...
pub fn find_single_process(
    ...
    Some(entity_ref) // Return the EntityReference immediately    
}
